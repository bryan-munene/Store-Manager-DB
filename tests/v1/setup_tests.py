...
class Store_Manager_Base(unittest.TestCase):
    ...
    def sign_up_user(self):
        ...
        '''
        sign_up = self.test_client.post('/api/v1/register', data = json.dumps(sample_user[0]), content_type = 'application/json')
        assert (sign_up.status_code == 201)
        logout= self.test_client.get('/api/v1/logout', content_type = 'application/json')
    ...
    def sign_in_user(self):
        ...
        '''
        sign_in = self.test_client.post('/api/v1/login', data = json.dumps(sample_user[1]), content_type = 'application/json')
    ...
    def sign_in_admin(self):
        ...
        '''
        sign_in = self.test_client.post('/api/v1/login', data = json.dumps(sample_user[2]), content_type = 'application/json')
    ...
    def add_items_helper(self):
        ...
        '''
        add_item = self.test_client.post('/api/v1/add_item', data=json.dumps(sample_item[0]) ,content_type='application/json', headers= self.token)
        assert(add_item.status_code==201)
        add_item = self.test_client.post('/api/v1/add_item', data=json.dumps(sample_item[1]) ,content_type='application/json', headers= self.token)
        assert(add_item.status_code==201)
    ...
    def make_sale_helper(self):
        ...
        '''
        sell = self.test_client.post('/api/v1/make_sale', data=json.dumps(sample_sale[0]) ,content_type='application/json', headers= self.token)
